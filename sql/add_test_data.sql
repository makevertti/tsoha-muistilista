...
insert into muistiinpano (kayttaja, nimi, lisatiedot, prioriteetti, lisayspaiva) values ((select id from kayttaja where kayttajatunnus='käyttäjä'), 'testimuistio1', 'kuvaus', 5, now());
insert into muistiinpano (kayttaja, nimi, lisatiedot, prioriteetti, lisayspaiva) values ((select id from kayttaja where kayttajatunnus='käyttäjä2'), 'testimuistio2', 'lisätietoa', 4, now());
